...
def wish():
    ...
    if time>= 0 and time<12:
        speak("good morning i am teddy how i can help you")

    elif time<18:
        speak("Good Afternoon i am teddy  how i can help you")

    else:
        speak("Good Evening i am teddy  how i can help you")
...
def callVoiceAssistant():
    ...
    while True:
        ...
        elif "i want to study" in command:
            speak("please tell subject")

        elif "class 10" in command:
            speak("please tell subject")

        elif "class 9" in command:
            speak("please tell subject")
        
        elif "class 8" in command:
            speak("please tell subject")
        
        elif "class 7" in command:
            speak("please tell subject")
        
        elif "maths" in command:
            speak("please tell chapter")

        elif "open real number" in command:
            webbrowser.open("google.com")
             
        
        elif "chapter 1" in command:
            webbrowser.open("google.com")

        elif "chapter 2" in command:
            webbrowser.open("google.com")

        elif "chapter 3" in command:
            webbrowser.open("google.com")

        elif "vice chancellor of noida international university" in command:
            speak("doctor uma bhaardh vaaj")
